...
<div style="display: flex; align-items: flex-start; gap: 20px; margin-bottom: 50px;">
  ...
  <div style="flex: 1;">
    ...
    <p>
      ...
      <a href="https://www.arxiv.org/abs/2509.22979">Preprint</a> · September 2025
    </p>
    <p>
...
<div style="display: flex; align-items: flex-start; gap: 20px; margin-bottom: 50px;">
  ...
  <div style="flex: 1;">
    ...
    <p>
      ...
      <a href="https://arxiv.org/abs/2506.06576">Preprint</a> · June 2025
    </p>
    <p>
...
<div style="display: flex; align-items: flex-start; gap: 20px; margin-bottom: 50px;">
  ...
  <div style="flex: 1;">
    ...
    <p>
      Developed at <strong>Rippling</strong> as a <strong>Machine Learning Engineering Intern</strong>. <em>Talent Signal</em> is an AI-based performance management product that leverages transformer-based classification models to assess employee performance.
